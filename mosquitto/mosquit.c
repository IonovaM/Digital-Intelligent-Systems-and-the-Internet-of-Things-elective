...
{
    static int count = 0;
    const int m[60] = {25, 27, 28, 30, 31, 33, 34, 35, 36, 37, 38, 39, 39, 40, 40, 40, 40, 40, 39, 39, 38, 37, 36, 35, 34, 33, 31, 30, 28, 27, 25, 23, 22, 20, 19, 18, 16, 15, 14, 13, 12, 11, 11, 10, 10, 10, 10, 10, 11, 11, 12, 13, 14, 15, 16, 18, 19, 20, 22, 23};
...
void publish_sensor_data(struct mosquitto *mosq)
{
     ...
     */
    rc = mosquitto_publish(mosq, NULL, "example/temperature09p", strlen(payload), payload, 2, false);
